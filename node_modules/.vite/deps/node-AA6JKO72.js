...
} from "./chunk-QYQEPCM3.js";
import {
  require_node_fs
} from "./chunk-XIB5YTZ3.js";
import {
  __commonJS,
  __toESM
...
var fs3 = __toESM(require_promises(), 1);
var fssync2 = __toESM(require_node_fs(), 1);
var path3 = __toESM(require_node_path(), 1);
var cp = __toESM(require_node_child_process(), 1);
var crypto = __toESM(require_node_crypto(), 1);
var readline = __toESM(require_node_readline(), 1);
...
var fs = __toESM(require_promises(), 1);
...
async function confineToRoot(root, p, opts) {
  const allowOutside = (opts == null ? void 0 : opts.allowOutside) ?? false;
...
async function atomicWriteFile(targetPath, content) {
  ...
  const tempPath = path.join(dir, `.tmp-${process.pid}-${(0, import_node_crypto.randomUUID)()}`);
  let handle;
  try {
...
var fs2 = __toESM(require_promises(), 1);
var fssync = __toESM(require_node_fs(), 1);
var path2 = __toESM(require_node_path(), 1);
...
//# sourceMappingURL=node-AA6JKO72.js.map
